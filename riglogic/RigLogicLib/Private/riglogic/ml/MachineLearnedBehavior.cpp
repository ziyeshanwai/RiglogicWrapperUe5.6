...
ConstArrayView<std::uint32_t> MachineLearnedBehavior::getNeuralNetworkIndicesForLOD(std::uint16_t lod) const {
    return evaluator->getNeuralNetworkIndicesForLOD(lod);
}
